      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
        ...
        <div className="flex gap-3">
          <div className="space-y-1 w-28 shrink-0">
            <label className="text-xs font-medium text-fg-muted">Shell</label>
            <Select
              value={form.shell}
          ...
          <div className="space-y-1 flex-1 min-w-0">
            <label className="text-xs font-medium text-fg-muted">工作目录</label>
            <Input
              value={form.cwd}
        ...
        {/* 标签 */}
        <div className="space-y-1">
          <label className="text-xs font-medium text-fg-muted">标签</label>
          <Input
            value={form.tags}
